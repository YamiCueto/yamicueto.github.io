(function () {
  ...
  */
   ...
   */
  function setupTypingEffectGSAP() {
      ...
      function typeRole() {
          ...
          const typingTL = gsapWithCSS.timeline({
              onComplete: () => {
                  // Pausa antes de borrar
                  gsapWithCSS.delayedCall(2.5, () => {
                      eraseRole();
                  });
              }
          });
      ...
      function eraseRole() {
          ...
          const eraseTL = gsapWithCSS.timeline({
              onComplete: () => {
                  currentRole = (currentRole + 1) % roles.length;
                  gsapWithCSS.delayedCall(0.8, typeRole);
              }
          });
      ...
      gsapWithCSS.delayedCall(1, typeRole);
  }

  /**
   * Fallback en caso de error
   */
  function setupTypingEffectFallback() {
      const typingElement = document.getElementById('typing-text');
      if (!typingElement) return;
