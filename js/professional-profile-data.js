...
window.professionalProfile = {
  ...
  "experience": [
    {
      ...
      "highlights": [
        "Desarrollo aplicaciones bancarias empresariales full stack con Java, Spring Boot, Angular y TypeScript en asignaciones de cliente de TCS.",
        "Contribuí a la migración de un sistema bancario legacy de VB6 a Java y Spring.",
        "Contribuí a flujos de CI/CD y calidad de código con SonarQube durante la asignación de Banistmo.",
        "Desarrollé herramientas de IA generativa con LLMs y generación aumentada por recuperación para apoyar los flujos de trabajo del equipo."
      ]
    },
    {
      "id": "softwareone",
  ...
  "links": {
    "portfolio": "https://yamicueto.github.io/",
    "linkedin": "https://linkedin.com/in/yamid-cueto-mazo",
